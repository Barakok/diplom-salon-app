...
const TimePicker = (props) => {
  ...
  const availableTimeArray = [
    [{disable: false, time: "08:00"},{disable: false, time: "08:30"},{disable: false, time: "09:00"},{disable: false, time: "09:30"}],
    [{disable: false, time: "10:00"},{disable: false, time: "10:30"},{disable: false, time: "11:00"},{disable: false, time: "11:30"}],
    [{disable: false, time: "12:00"},{disable: false, time: "12:30"},{disable: false, time: "13:00"},{disable: false, time: "13:30"}],
    [{disable: false, time: "14:00"},{disable: false, time: "14:30"},{disable: false, time: "15:00"},{disable: false, time: "15:30"}]];

  const valueDate = new Date().toString().substr(16, 5);
